            ...
            <a-row :gutter="12">
              ...
              <a-col :span="12">
                <a-form-item
                  ...
                  label="创建者"
                >
                  <a-input v-model="crud.options.form.createBy" />
                </a-form-item>
              </a-col>
              <!--更新者-->
              <a-col :span="12">
                <a-form-item
                  ...
                  label="更新者"
                >
                  <a-input v-model="crud.options.form.updateBy" />
                </a-form-item>
              </a-col>
              <!--创建时间-->
              <a-col :span="12">
                ...
                >
                  <a-date-picker
                    v-model="crud.options.form.createTime"
                    show-time
              ...
              <a-col :span="12">
                ...
                >
                  <a-date-picker
                    v-model="crud.options.form.updateTime"
                    show-time
                    format="YYYY-MM-DD HH:mm:ss"
                    style="width: 100%"
                  />
        ...
        >
          ...
          <template #createBy="{ record }">
            ...
            <div v-if="!record.editable && crud.options.tableInfo.isEdit">
              ...
              <div v-if="crud.options.form[record.id]">
                {{
                  crud.options.form[record.id].createBy
                    ? crud.options.form[record.id].createBy
                    : record.createBy
                }}
              </div>
            ...
            <div v-if="record.editable">
              <a-input
                v-model="crud.options.form[record.id].createBy"
                :default-value="record.createBy"
              />
            </div>
          </template>
          ...
          <template #updateBy="{ record }">
            ...
            <div v-if="!record.editable && crud.options.tableInfo.isEdit">
              ...
              <div v-if="crud.options.form[record.id]">
                {{
                  crud.options.form[record.id].updateBy
                    ? crud.options.form[record.id].updateBy
                    : record.updateBy
                }}
              </div>
            ...
            <div v-if="record.editable">
              <a-input
                v-model="crud.options.form[record.id].updateBy"
                :default-value="record.updateBy"
              />
            </div>
          </template>
          ...
          <template #updateTime="{ record }">
            ...
            <div v-if="!record.editable && crud.options.tableInfo.isEdit">
              ...
              <div v-if="crud.options.form[record.id]">
                {{
                  crud.options.form[record.id].updateTime
                    ? crud.options.form[record.id].updateTime
                    : record.updateTime
                }}
              </div>
            ...
            <div v-if="record.editable">
              <a-date-picker
                v-model="crud.options.form[record.id].updateTime"
                show-time
                :default-value="record.updateTime"
                format="YYYY-MM-DD HH:mm:ss"
                style="width: 100%"
              />
            </div>
